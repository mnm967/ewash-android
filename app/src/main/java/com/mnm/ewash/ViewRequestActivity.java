...
public class ViewRequestActivity extends AppCompatActivity{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        boolean con = NetworkUtils.isNetworkConnected(ViewRequestActivity.this, new DialogInterface.OnClickListener() {
            @Override
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(ViewRequestActivity.this, R.style.DialogCustom))
                .setTitle("Processing...")
        ...
        LinearLayoutManager lm = new LinearLayoutManager(ViewRequestActivity.this);
        ...
        history.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                HistoryCardViewAdapter adapter = new HistoryCardViewAdapter(ViewRequestActivity.this, userRequests);
